        ...
        <div className="grid grid-cols-[110px_1fr_1fr_1fr]">
          ...
          <Cell small className="px-2 py-1">
            ...
            <div className="flex min-h-[23px] flex-wrap items-center">
              <CheckText checked={admission.year2} label="2학년(2nd)" />
              <CheckText checked={admission.year3} label="3학년(3nd)" />
              <CheckText checked={admission.year4} label="4학년(4nd)" />
            </div>
          </Cell>

          <Cell small className="px-2 py-1">
            <div className="flex min-h-[23px] flex-wrap items-center border-b border-black">
              <CheckText checked={admission.dual} label="복수학위 (Dual Degree)" />
            </div>
            <div className="flex min-h-[23px] flex-wrap items-center">
              <CheckText checked={admission.dual22} label="2+2" />
              <CheckText checked={admission.dual31} label="3+1" />
            </div>
          </Cell>
        </div>
