...
function getLanguageProgramLabel(student) {
  const raw = student.program_track || student.programTrack || "";
  if (raw === "Korean Language Program" || raw.includes("한국어")) {
    return "한국어 어학연수 (Korean Language Program)";
  }
  if (raw === "English Language Program" || raw.includes("영어") || raw.includes("English")) {
    return "영어 어학연수 (English Language Program)";
  }
  return raw || "-";
}
...
export default function LanguageApplicationFormPreview({ student, photoUrl = "" }) {
  ...
  const programLanguageLabel = getLanguageProgramLabel(student);
  ...
  page-break-inside: avoid;
      ...
      <div className="application-page page-1">
        ...
        <div className="mt-2 grid grid-cols-[150px_minmax(0,1fr)_306px]">
