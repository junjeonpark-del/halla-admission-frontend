...
if (lockError) throw lockError;
  ...
  }, [inKorea, financialGuaranteeRequired]);
...
const buildPassportWarnings = (ocrResult, currentForm) => {
  ...
  if (ocrName && formName && ocrName !== formName) {
    warnings.push(
      buildMismatchMessage(t.common.passportNameMismatch, rawFormName, rawOcrName)
    );
  }
  ...
  if (ocrDob && formDob && ocrDob !== formDob) {
    warnings.push(
      buildMismatchMessage(t.common.passportBirthMismatch, rawFormDob, rawOcrDob)
    );
  }
