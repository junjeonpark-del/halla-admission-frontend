...
const messages = {
  zh: {
    ...
    common: {
      ...
      signatureMethod: "签字方式", signatureHelper: "请选择签字方式。最终会自动回填到学校申请表所有对应签字位置。", autoSignatureDesc: "自动生成签字将基于当前姓名字段生成：",
      ...
      generatedSignatureTip: "已生成签字预览。后续管理员下载学校格式申请表时，可自动放入对应签字位置。", passportReminderTitle: "护照信息辅助提醒", passportChecking: "正在识别护照信息并与申请表进行比对，请稍候...", passportReminderDesc: "该提醒仅供人工复核参考，不影响保存草稿或提交申请。",
    ...
    options: {
      ...
      signatureMethods: [{ value: "auto", label: "自动生成签字" }, { value: "draw", label: "手写签字" }, { value: "upload", label: "上传签字图片" }],
        ...
        {options.map((option) => {
          ...
          return (
            <label
              key={optionValue}
              className={[
                "inline-flex cursor-pointer items-center rounded-xl border px-4 py-3 text-sm font-medium transition",
                value === optionValue
