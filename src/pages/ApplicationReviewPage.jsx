...
function ApplicationReviewPage() {
  ...
  @media print {
    ...
    .personal-statement-form .border,
    .personal-statement-form table,
    .personal-statement-form tr,
    .personal-statement-form td {
      break-inside: avoid !important;
      page-break-inside: avoid !important;
    }

    .personal-statement-form .mt-4 {
      margin-top: 6px !important;
    }

    .personal-statement-form .p-4 {
      padding: 8px !important;
    }

    .personal-statement-form .py-5 {
      padding-top: 8px !important;
      padding-bottom: 8px !important;
    }

    .personal-statement-form .py-2 {
      padding-top: 4px !important;
      padding-bottom: 4px !important;
    }

    .personal-statement-form .px-3,
    .personal-statement-form .px-4 {
      padding-left: 8px !important;
      padding-right: 8px !important;
    }

    .personal-statement-form .text-\\[20px\\] {
      font-size: 16px !important;
      line-height: 1.2 !important;
    }

    .personal-statement-form .text-\\[13px\\] {
      font-size: 11px !important;
      line-height: 1.2 !important;
    }

    .personal-statement-form .text-\\[12px\\] {
      font-size: 11px !important;
      line-height: 1.2 !important;
    }

    .personal-statement-form .text-\\[11px\\] {
      font-size: 10px !important;
      line-height: 1.2 !important;
    }

    .personal-statement-form .leading-5 {
      line-height: 1.25 !important;
    }

    .personal-statement-form .min-h-\\[180px\\] {
