...
function StudentLanguageApplicationPage() {
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        {currentStep === 0 && (
          <SectionCard
            ...
            desc={txt("请填写课程语言和宿舍申请。", "Enter program language and dormitory request.", "과정 언어 및 생활관 신청 여부를 입력하세요.")}
          >
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-2">
              <Select
                label={txt("课程语言 (Program Language)", "Program Language", "과정 언어")}
                required
                disabled={isReadOnly}
...
export default StudentLanguageApplicationPage;
