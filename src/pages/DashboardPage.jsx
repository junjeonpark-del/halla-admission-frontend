...
const messages = {
  zh: {
    ...
    openIntakesTitle: "当前开放批次",
    openIntakesDesc: "当前机构端可提交申请的批次",
  ...
  en: {
    ...
    openIntakesTitle: "Current Open Intakes",
    openIntakesDesc: "Intakes currently available for agency submission",
  ...
  ko: {
    ...
    openIntakesTitle: "현재 오픈 차수",
    openIntakesDesc: "현재 기관이 제출할 수 있는 차수",
