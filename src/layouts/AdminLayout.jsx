  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 break-words">
        {label}
                  {safeBadgeCount > 0 ? (
          <span className="ml-2 inline-flex h-5 min-w-5 items-center justify-center whitespace-nowrap rounded-full bg-red-600 px-1.5 text-xs font-bold leading-none text-white shadow-sm">
